<div id="restaurant-navbar " class="container topbar" >
  ...
  <ul class="nav nav-pills">
    ...
    <li class="nav-item" id="restaurantnavlink-orders">
      <a class="nav-link" href="../../php/restaurantcontent/restaurantoverview.php">Orders <span class="sr-only">(current)</span></a>
    </li>
    <li class="nav-item" id="restaurantnavlink-menu">
      <a class="nav-link" href="../../php/restaurantcontent/menu-overview.php">Menu</a>
    </li>
    <li class="nav-item" id="restaurantnavlink-history">
      <a class="nav-link" href="../../php/restaurantcontent/history.php">History</a>
    </li>
  </ul>
</div>
</div>
